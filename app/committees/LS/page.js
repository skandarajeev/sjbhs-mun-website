    ...
    <div className="main-div">
      <div className={`  grid grid-rows-1 md:grid-cols-2 p-[1rem]`}>
        ...
        <div>
          ...
          <p>
            Special session discussing the Naxalbari crisis
            </p>
            <p>
            Freeze Date: 1967, December 1st
            </p>
          </div>
          <div className="">
            <p
        ...
        <div className="grid grid-cols-1 gap-3  ">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <Link className = "flex justify-center " href = "https://docs.google.com/spreadsheets/d/17QI9NBp9A3DLMZlQCAAJvSKXwrxAtV4egpU1UuD59h8/edit#gid=740523698" >
                <button
                  type="button"

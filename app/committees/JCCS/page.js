      ...
      <div className={`  grid grid-rows-1 md:grid-cols-2 p-[1rem]`}>
        ...
        <div>
          ...
          <div className="">
            ...
            >
              COMMTTEEE 1 : The Soviets were like a formidable shield, a steel
            ...
            >
              COMMITTEE 2 : The Soviets were like a formidable shield, a steel
              phalanx bound by the oath of Marxist-Leninist ideology. They stood
              as a majestic mountain range, impervious to the tempestuous winds
              of uncertainty, a beacon of solidarity in a turbulent sea of
              global geopolitics, guarding the shores of democracy. Their
        ...
        <div className="grid grid-cols-1 gap-3  ">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div className="mt-[5rem] mb-[5rem] w-[100%] rounded-xl p-[1rem] flex flex-col">
              <p
                className={`${styles.mungradient} flex justify-center mb-[2rem] text-[2rem] font-semibold`}
              >
                COMING SOON!
              </p>
              <button
                type="button"
                class="mb-[1rem] text-white bg-indigo-500 hover:bg-indigo-800 focus:outline-none focus:ring-4 focus:ring-indigo-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800 "
              >
                Country Matrix
              </button>
              <button
                type="button"
                class="text-white bg-indigo-500 hover:bg-indigo-800 focus:outline-none focus:ring-4 focus:ring-indigo-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-indigo-600 dark:hover:bg-indigo-700 dark:focus:ring-indigo-800"
              >
                Background guide
              </button>
            </div>

      ...
      <div className={`  grid grid-rows-1 md:grid-cols-2 p-[1rem]`}>
        ...
        <div>
          <div className="  mt-[5rem] text-[10vw] md:text-[7vw] place-items-center w-[100%]">
            <p className={`${styles.mungradient} text-white font-poppins font-bold  text-center md:text-left text-[5vw] md:text-[3vw]`}>
              JOINT CRISIS COMMITTEE :
            </p>
            <p className={`${styles.mungradient} text-white font-poppins font-bold  text-center md:text-left text-[6vw] md:text-[5vw] mt-[1rem] mb-[2rem]`}>
              ATLANTIC
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-3  ">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <Link className = "flex justify-center " href = "https://docs.google.com/spreadsheets/d/17QI9NBp9A3DLMZlQCAAJvSKXwrxAtV4egpU1UuD59h8/edit#gid=1865576388" >
                <button
                  type="button"

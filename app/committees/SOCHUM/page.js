    ...
    <div className="main-div">
      <div className={`  grid grid-rows-1 md:grid-cols-2 p-[1rem]`}>
        ...
        <div>
          ...
          <div className="agenda text-white gap-5 flex flex-col mun-gradient font-semibold text-[1.2rem] leading-[1.6rem]">
          <p>
          Protection of the rights and culture of indigenous people with reference to the impacts of climate change.
            </p>
          </div>
          <div className="">
            <p
        ...
        <div className="grid grid-cols-1 gap-3  ">
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <Link className = "flex justify-center " href = "https://docs.google.com/spreadsheets/d/17QI9NBp9A3DLMZlQCAAJvSKXwrxAtV4egpU1UuD59h8/edit#gid=0" >
                <button
                  type="button"

              ...
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <div className="mb-8 flex w-full max-w-[370px] md:hidden">
                  ...
                  <div className="w-full">
                    <h4 className="mun-gradient mb-1 text-xl font-bold text-dark">
                      Our Location
                    </h4>
              ...
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 bg-blue-600 text-white transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>

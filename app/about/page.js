...
<br></br>
  ...
  `}</p>
        ...
        <div
          className={` ${style.background}  md:grid md:grid-cols-2 background m-[0.5rem] mb-11 sm:mx-[1rem] md:mx-[2rem] lg:mx-[10rem] rounded-[1rem] h-[100%] p-[1rem]`}
        >
          <div className="relative  mb-8 flex items-center justify-center">
            <p className="text-white text-center font-poppins text-[8vw] md:text-[4vw] ">
              About SJBHSMUN
            </p>
          </div>
          <div
            className={`${style.backie} relative  p-[1rem] m-[0.5rem] md:p-[2rem] text-left  md:text-left rounded-lg `}
          >
